...
const SAMPLE_CARS = [
  {
    ...
    images: JSON.stringify(['/images/cars/swift-vxi.png']),
  },
  {
    ...
    images: JSON.stringify(['/images/cars/creta-sx.png']),
  },
  {
    name: 'Tata Nexon XZ+',
    brand: 'Tata',
    ...
    images: JSON.stringify(['/images/cars/tata-nexon.png']),
  },
  {
    ...
    images: JSON.stringify(['/images/cars/fortuner.png']),
  },
  {
    ...
    images: JSON.stringify(['/images/cars/honda-city.png']),
  },
  {
    name: 'Kia Seltos HTX',
    brand: 'Kia',
    ...
    images: JSON.stringify(['/images/cars/kia-seltos.png']),
  },
  {
    ...
    images: JSON.stringify(['/images/cars/bmw-3series.png']),
  },
  {
    ...
    images: JSON.stringify(['/images/cars/mercedes-cclass.png']),
  },
  {
    ...
    images: JSON.stringify(['/images/cars/honda-city-grey.png']),
  },
  {
    ...
    images: JSON.stringify(['/images/cars/mg-hector.png']),
  },
];
